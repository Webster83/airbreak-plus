...
FIELDS = {
    ...
    "PCB": {"off": 0x16, "len": 16, "desc": ""},
    "VPC": {"off": 0x26, "len": 5,  "desc": ""},
    "VRN": {"off": 0x30, "len": 11, "desc": ""},
    "PCD": {"off": 0x42, "len": 5,  "desc": "product code"},
    "SRN": {"off": 0x4C, "len": 11, "desc": "serial number"},
    "PNA": {"off": 0x5E, "len": 16, "desc": "product name"},
    "FGT": {"off": 0x6E, "len": 16, "desc": ""},
    "CCP": {"off": 0x7E, "len": 2,  "desc": ""},
    "CCS": {"off": 0x80, "len": 2,  "desc": ""},
}
...
def set_field(data: bytearray, key: str, value: bytes):
    ...
    if key in ("PNA", "FGT", "PCB"):
        if len(value) > max_len:
            raise ValueError(f"{key} too long (max {max_len} bytes)")
