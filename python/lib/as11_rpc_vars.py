...
EVENT_FAMILIES: dict[str, tuple[str, ...]] = {
    ...
    "SystemActivityEvents-SporadicActivityEvents": (
        ...
        "RPCApplyUpgradeSuccessfulResponse",
        "RPCApplyUpgradeFailureResponse",
        "RPCAuthenticatedApplyUpgradeSuccessfulResponse",
        "RPCAuthenticatedApplyUpgradeFailureResponse",
        "BluetoothSecureCodeInvalid", "BTIncorrectAuthenticationResponse",
        "BTOutOfSequenceMessage", "IncorrectUpgradeType",
        "UpgradeFileIntegrityFailure", "BlockedOutlet", "BlockedInlet",
        "BluetoothDataCorruption", "SDCardFormatted", "SDCardRemoved",
        "SDCardReadError", "SDCardWriteError", "SDReadOnlyCardInserted",
        "EndcapConnected", "EndcapDisconnected", "DataIntegrityFailure",
        "EventLogDataError", "LimpModeOn", "LimpModeOff",
        "TouchScreenI2CError", "SDCardFull",
        "BTSecureRPCOnInsecureChannel", "DataModeSilent", "DataModeActive",
        "TubRemovedDuringSoundcheck", "MotorEndOfLifeReached",
        "BluetoothPeripheralScanningAvailableDevices",
        "BluetoothOximeterFound",
        "BluetoothOximeterJustWorksPairingEstablished",
        "BluetoothOximeterIncompatibleDevice", "BluetoothOximeterForgotten",
        "SporadicEventsFloodingMitigated", "SetupExperienceBypassed",
        "LearnTargetsStarted", "LearnTargetsStopped", "LearnTargetsFailed",
        "LearnTargetsCompleted", "LearnTargetsAccepted",
        "DeviceCheckInitiated", "DeviceCheckPassed",
        "DeviceCheckSystemError", "DeviceCheckNotificationDisplayed",
        "MaskReminderAcknowledged", "TubingReminderAcknowledged",
        "FilterReminderAcknowledged", "HumidifierReminderAcknowledged",
        "TestDriveTimedOut", "FgUpgradeFileFingerprintMismatch",
        "FgUpgradeFileSignatureMismatch",
        "AlarmUpgradeFileSignatureMismatch", "InvalidUpdaterSoftware",
    ),
    "SystemExceptionEvents-SystemErrors": (
    ...
    "SystemExceptionEvents-RecoverableErrors": (
        "NoError", "HoseBlocked", "HoseDisconnected",
